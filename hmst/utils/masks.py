...
hmst.utils.masks
================
Hierarchical R-Tree attention mask builders for HMST-v2.
...
Usage (inside notebook after building forest_levels)::

    from hmst.utils.masks import build_forest_masks
